...
CREATE TABLE `product` (
  ...
  `web_category` varchar(500) NOT NULL,
  `last_date` varchar(45) NOT NULL DEFAULT 'CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP',
...
-- Dump completed on 2025-04-08 15:38:49
